...
subjects = ['Dog_4', 'Dog_1']
fig = plt.figure(figsize=(10, 1.7))
ax = fig.add_subplot(111)
c_test = '#ff3333'
c_holdout = '#ff3333' #'#bebada'
c_train = '#8dd3c7'
...
for i, s in zs:
    ...
    patch_handles.append(ax.barh(i+0.5, len(train_times) * 0.166666901961, height=0.3,
    ...
    # test
    patch_handles.append(ax.barh(i+0.5, len(ttimes) * 0.166666901961, height=0.3,
